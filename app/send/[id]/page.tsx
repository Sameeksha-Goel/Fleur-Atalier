  ...
  return (
    <main className="min-h-screen bg-cream">
      <div className="max-w-[480px] mx-auto px-6 py-12 flex flex-col items-center gap-8">
        ...
        >
          {/* Float wrapper starts after entrance finishes */}
          <motion.div
            animate={{ y: [0, -10, 0] }}
            transition={{
              duration: 3,
        ...
        >
          <Link
            href="/create"
            className="border border-terracotta text-terracotta font-sans text-sm py-3 px-8 rounded-full hover:bg-terracotta/8 active:scale-[0.98] transition-all"
          >
            Send one back
          </Link>
